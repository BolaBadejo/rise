...
class _ViewListingScreenState extends State<ViewListingScreen> {
                    ...
                    Container(
                      ...
                      child: Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            "N${widget.dataModel['minimun_offer']!}",
                            overflow: TextOverflow.ellipsis,
                            style: GoogleFonts.poppins(
                              // fontFamily: 'Chillax',
                              color: blackColor,
  ...
  Widget build(BuildContext context) {
    // print(widget.dataModel['minimun_offer']);
    return Scaffold(
              ...
              child: ExpandableCarousel.builder(
                ...
                itemBuilder:
                  ...
                  child: CachedNetworkImage(
                    ...
                    fit: BoxFit.cover,
                    imageUrl: widget.imageUrl[itemIndex],
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    //           Align(
                    //               alignment: Alignment.center,
                    //               child: Image.asset("assets/images/banj.png")),
                    //           const SizedBox(
                    //             height: 10,
                    //           ),
                    //           Divider(
