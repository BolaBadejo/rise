...
class BioDataKYC extends StatefulWidget {
  final type;
  const BioDataKYC({Key? key, required this.type}) : super(key: key);

  @override
  BioDataKYCState createState() => BioDataKYCState();
}

class BioDataKYCState extends State<BioDataKYC> {
  var selectedListing;
