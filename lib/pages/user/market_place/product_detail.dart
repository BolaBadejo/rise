          ...
          Positioned(
            ...
            child: SizedBox(
              ...
              child: ExpandableCarousel.builder(
                ...
                itemCount: widget.dataModel.listingImages!.length,
                itemBuilder:
                  ...
                  child: AspectRatio(
                    ...
                    child: CachedNetworkImage(
                      ...
                      fit: BoxFit.cover,
                      imageUrl: widget.dataModel.listingImages![itemIndex],
                  ...
                  children: [
                          ...
                          RichText(
                            text: TextSpan(
                              children: [
                                ...
                                TextSpan(
                                  text: " ${widget.dataModel.serviceOffering}",
                                  // overflow: TextOverflow.ellipsis,
                                  style: GoogleFonts.poppins(
                                    // fontFamily: 'Chillax',
                                    color: blackColor,
                    ...
                    Padding(
                      ...
                      child: RiseButtonNew(
                          ...
                          textColor: whiteColor,
                          onPressed: () {
                            String result = widget.dataModel.minimumOffer!
                                .toString()
                                .substring(
                                    0,
                                    widget.dataModel.minimumOffer!
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(left: 20.0),
                        child: Text(
                          "Other listings by ${widget.dataModel.user['full_name']}",
                          style: GoogleFonts.poppins(
                            // fontFamily: 'Chillax',
                            color: blackColor,
                            fontWeight: FontWeight.w600,
                            ...
                            child: Center(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Divider(
                                    color: grayColor
                                        .withOpacity(0.3), //color of divider
