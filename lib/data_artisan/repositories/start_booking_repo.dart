...
class StartBookingRepository {
  ...
  Future<StartBookingResponse> fetchStartBookingData(
      StartBookingRequest createBookingRequest) async {
    SharedPreferences sharedPreference = await SharedPreferences.getInstance();
    String getToken = sharedPreference.get('access_token').toString();
    final response = await _provider.createStartBookingRequest(
        "/booking/start-booking", createBookingRequest, getToken);
