...
class RegisterNewUserRepository {
  ...
  Future<RegisterNewUserResponse> fetchRegisterNewUseData(
      RegisterNewUserRequest registerNewUserRequest) async {
    final response = await _provider.postLoginRequest(
        "/auth/register", registerNewUserRequest);
